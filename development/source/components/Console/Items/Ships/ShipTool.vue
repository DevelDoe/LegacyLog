...
<template lang="html">
    <div class="ship-tool">
        <DevelModal modal="addShip">
            <div slot="header"> <h2>Model Ship</h2> </div>
            <div slot="bread">
                <form id="modal-form-ship-tool">
                    ...
                    <div v-for="( weapon, i ) in ship.weapons">
                        ...
                        <input class="small" v-model="weapon.count" placeholder="Total Mounts">
