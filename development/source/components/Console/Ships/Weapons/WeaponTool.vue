        ...
        <LoadoutModal modal="addWeapon">
            ...
            <div slot="footer">
                <div class="form-control">
                    <button form="modal-form-weapon-tool" @click="save('addWeapon')">save</button>
                </div>
            </div>
        </LoadoutModal>

        <div class="tool-control">
            <button @click="openModal('addWeapon')">add weapon</button>
        </div>
...
export default {
    ...
    methods: {
        ...
        save( modal ) {
            const valid = this.validate( this.meta_data.validation_rules.weapon, this.weapon, 'weapons')
            if( valid === 'true' ) {
                this.apiSave( 'weapons', this.weapon, 'addWeapon', modal)
                this.weapon.organisation_id      = ''
                this.weapon.model                = ''
                this.weapon.desc                 = ''
                this.weapon.size                 = ''
                this.weapon.sim_dps_3s           = ''
                this.weapon.sim_dps_10s          = ''
                this.weapon.sim_dps_30s          = ''
                this.weapon.sim_dps_60s          = ''
                this.weapon.sim_dps_90s          = ''
                this.weapon.dps                  = ''
                this.weapon.shot_per_minute      = ''
                this.weapon.default_rounds       = ''
                this.weapon.ammo_id              = ''
                this.weapon.burst_rate           = ''
                this.weapon.burst_shots          = ''
                this.weapon.burst_dps            = ''
                this.weapon.spread_first         = ''
                this.weapon.spread_per_shot      = ''
                this.weapon.spread_max           = ''
                this.weapon.spread_min           = ''
                this.weapon.spread_instability   = ''
                this.weapon.spread_decay         = ''
                this.weapon.spread_decay_end     = ''
                this.weapon.power_online         = ''
                this.weapon.heat_shot            = ''
                this.weapon.heat_rate_online     = ''
                this.weapon.temp_max             = ''
                this.weapon.cooling_coefficient  = ''
                this.weapon.heating_coefficient  = ''
                this.weapon.temp_ratio_overheat  = ''
                this.weapon.temp_ratio_recovery  = ''
                this.weapon.heat_recovery        = ''
                this.weapon.temp_ratio_ir        = ''
                this.weapon.dst_decay_rate       = ''
                this.weapon.dst_max              = ''
                this.weapon.dst_ratio_overload   = ''
                this.weapon.dst_ratio_recovery   = ''
                this.weapon.em_ratio             = ''
                this.weapon.dmg_resist_phys      = ''
                this.weapon.dmg_resist_nrg       = ''
                this.weapon.dmg_resist_dst       = ''
                this.weapon.dmg_resist_heat      = ''
                this.weapon.dmg_resist_bio       = ''
                this.weapon.wear_lifetime        = ''
                this.weapon.wear_initial_ratio   = ''
                this.weapon.wear_degrade_on_use  = ''
                this.weapon.wear_heat            = ''
                this.weapon.wear_overhear        = ''
                this.weapon.wear_overclock       = ''
                this.weapon.wear_critical        = ''
                this.weapon.wear_performance     = ''
                this.weapon.wear_dmg_perf        = ''
                this.weapon.wear_dmg_efficiency  = ''
                this.weapon.wear_dmg_heat        = ''
                this.weapon.wear_critical        = ''
            }
        }
    }
